...
func (e *Encoder) boxType(v *BoxType) (err os.Error){
     ...
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "942c78489989cefa7ca701ada38081c54a227e5de8c3fe211ea465000eab4ff9fe29f1ccb0ee33a4a7f20c07717aee52f32a9a05cb3857cdfa57a94833ec28ff", uint64(unsafe.Sizeof(*v))); error == nil {
     	
       err = e.float64(v.lower_x)
       if err != nil {
       	  return err
       }
       
       err = e.float64(v.lower_y)
       if err != nil {
       	  return err
       }
       
       err = e.float64(v.upper_x)
       if err != nil {
       	  return err
       }
       
       err = e.float64(v.upper_y)
       if err != nil {
       	  return err
       }
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case BoxType:
     	hashByte, err := hex.DecodeString("942c78489989cefa7ca701ada38081c54a227e5de8c3fe211ea465000eab4ff9fe29f1ccb0ee33a4a7f20c07717aee52f32a9a05cb3857cdfa57a94833ec28ff")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("942c78489989cefa7ca701ada38081c54a227e5de8c3fe211ea465000eab4ff9fe29f1ccb0ee33a4a7f20c07717aee52f32a9a05cb3857cdfa57a94833ec28ff")
     	// e.string("942c78489989cefa7ca701ada38081c54a227e5de8c3fe211ea465000eab4ff9fe29f1ccb0ee33a4a7f20c07717aee52f32a9a05cb3857cdfa57a94833ec28ff")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("942c78489989cefa7ca701ada38081c54a227e5de8c3fe211ea465000eab4ff9fe29f1ccb0ee33a4a7f20c07717aee52f32a9a05cb3857cdfa57a94833ec28ff")):
...
func (t *BoxType) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x94,0x2c,0x78,0x48,0x99,0x89,0xce,0xfa,0x7c,0xa7,0x01,0xad,0xa3,0x80,0x81,0xc5,0x4a,0x22,0x7e,0x5d,0xe8,0xc3,0xfe,0x21,0x1e,0xa4,0x65,0x00,0x0e,0xab,0x4f,0xf9,0xfe,0x29,0xf1,0xcc,0xb0,0xee,0x33,0xa4,0xa7,0xf2,0x0c,0x07,0x71,0x7a,0xee,0x52,0xf3,0x2a,0x9a,0x05,0xcb,0x38,0x57,0xcd,0xfa,0x57,0xa9,0x48,0x33,0xec,0x28,0xff, }  
